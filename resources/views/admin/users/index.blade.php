      ...
      <table class="table table-striped table-bordered dataex-res-configuration">
       ...
       <tbody>
        ...
        <tr>
         ...
         <td>
          <a href="{{ route('admin.permissions.edit', $user->id) }}" class="btn btn-warning btn-sm">Edit</a>
          <a href="{{ route('admin.permissions.show', $user->id) }}" class="btn btn-primary btn-sm">Show</a>
