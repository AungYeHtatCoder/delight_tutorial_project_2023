 ...
 <div class="content-header-light col-12">
  <div class="row">
   <div class="content-header-left col-md-9 col-12 mb-2">
    <h3 class="content-header-title">Responsive Art Photo</h3>
    <div class="row breadcrumbs-top">
     <div class="breadcrumb-wrapper col-12">
      <ol class="breadcrumb">
       ...
       <li class="breadcrumb-item active">Art Photo
       </li>
      </ol>
     </div>
    </div>
...
<section id="image-gallery" class="card">
 <div class="card-header">
  <h4 class="card-title">Image gallery
   <span><a href="{{ route('admin.artphotos.create') }}" class="btn btn-primary">Create New Art Photo</a></span>
  </h4>
  <a class="heading-elements-toggle"><i class="la la-ellipsis-v font-medium-3"></i></a>
  <div class="heading-elements">
   <ul class="list-inline mb-0">
 ...
 <div class="card-content collapse show">
  ...
  <div class="card-body  my-gallery">
   <div class="row">
    @foreach($art_photos as $photo)

    <figure class="col-lg-3 col-md-6 col-12" itemprop="associatedMedia" itemscope
     itemtype="http://schema.org/ImageObject">
     <a href="{{ $photo->photo }}" itemprop="contentUrl" data-size="480x360">
      <img class="img-thumbnail img-fluid" src="{{ $photo->photo }}" itemprop="thumbnail" alt="" />
     </a>
    </figure>
    @endforeach
